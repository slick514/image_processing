...
np100 = np.uint8([100])
np200 = np.uint8([200])
print("OpenCV clips above 256\ncv2.add([200], [100]) = {}\n".format(str(cv2.add(np200, np100))))
print("OpenCV clips below 0\ncv2.subtract([50], [100]) = {}\n".format(str(cv2.subtract(np50, np100))))
...
print("Numpy wraps above 256\n[200] + [100] = {}\n".format(str(np200 + np100)))
print("Numpy wraps below 0\n[50] - [100] = {}\n".format(str(np50 - np100)))
